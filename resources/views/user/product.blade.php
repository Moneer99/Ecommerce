      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
            ...
            <a href="{{ route('allproducts') }}">view all products <i class="fa fa-angle-right"></i></a>

            {{-- Search bar for product -------- --}}
          <form action="{{ route('search') }}" method="get" class='form-inline' style='float: right;padding:10px;display:flex;'>
            @csrf
